...
public class SanPham {
    ...
    public SanPham(int id_loai_san_pham, int id_chat_lieu, int id_kieu_dang, int id_kieu_co_giay, int id_kieu_day_giay, int id_thuong_hieu, int id_xuat_su, int id_mau_sac, int id_kich_co, String ma_san_pham, String ten_san_pham, String mo_ta, LocalDate ngay_tao, LocalDate ngay_cap_nhat, boolean trang_thai, boolean trang_thai_xoa) {
    ...
    public SanPham(int id_san_pham, int id_loai_san_pham, int id_chat_lieu, int id_kieu_dang, int id_kieu_co_giay, int id_kieu_day_giay, int id_thuong_hieu, int id_xuat_su, int id_mau_sac, int id_kich_co, String ma_san_pham, String ten_san_pham, String mo_ta, LocalDate ngay_tao, LocalDate ngay_cap_nhat, boolean trang_thai, boolean trang_thai_xoa) {
